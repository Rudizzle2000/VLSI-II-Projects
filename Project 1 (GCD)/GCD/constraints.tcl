...
#create_clock -name clk -period 4.5 [get_pins gcd/clk_i]

#create_clock -name clk -period 3.7 [get_ports clk_i]   


create_clock -name clk -period 3.8 [get_ports clk_i]                                                                                                                                      
set_clock_uncertainty 0.100 [get_clocks clk]                                                                                                                                                 
                                                                                                                                                                                             
# Always set the input/output delay as half periods for clock setup checks                                                                                                                   
set_input_delay  1.9 -max -clock [get_clocks clk] [all_inputs] 
set_output_delay 1.9 -max -clock [get_clocks clk] [all_outputs]                                                                                                                                                                                                                   
